...
public class PokemonScreenLAB9 extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		currentPosx = rand.nextInt(W/STEP_SIZE) * STEP_SIZE; // this should be a random position
		currentPosy = rand.nextInt(H/STEP_SIZE) * STEP_SIZE; // this should be a random position
